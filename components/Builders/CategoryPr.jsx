...
const CategoryPr = ({ data, i, isMobile }) => {
    ...
    //     )
    // }, [load])
    // console.log(data, 'data from CategoryPr')
    return (
        <>
            {/* {memoziedState} */}
            
            <div className="main-width gap-[15px] your-element md:pt-[20px] md:h-[475px] md:w-full">
                {data.top_image && <div className="flex items-center justify-center lg:mt-[50px] md:px-[15px] relative your-element">
                    <Image src={check_Image(data.top_image)} className="your-element" width={600} height={300} alt={data.title} />
                </div>}
