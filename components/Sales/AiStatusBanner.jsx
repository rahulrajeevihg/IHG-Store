export default function AiStatusBanner({ aiSession, onClear }) {
  ...
  // degradation, so we do NOT surface it as a warning. Only genuinely useful
  // notices are shown below: relaxed filters and low result quality.
  ...
  if (!hasRelaxations && !isWeak) return null;
